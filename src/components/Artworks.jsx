  ...
  return (
      ...
      <div className="w-4/5 py-10 mx-auto">
        <h4 className="text-blue-300 text-3xl font-bold uppercase text-blue-300">
          {collection.length > 1 ? 'Latest Artworks' : 'My Artworks'}
        </h4>
    ...
    <div className="w-full shadow-xl shadow-black rounded-md overflow-hidden bg-gray-800 my-2 p-3">
      ...
      <div className="flex justify-between items-center mt-3 text-white">
        <div className="flex flex-col">
          <small className="text-xs">Price Tag</small>
          <p className="text-sm font-semibold">{nft.cost} ETH</p>
        </div>

        <button
                  className="shadow-lg shadow-black text-black text-sm bg-[#FFD700]
            hover:bg-[#FFD700] cursor-pointer rounded-full px-1.5 py-1"
          onClick={setNFT}
        >
          View Details
        </button>
